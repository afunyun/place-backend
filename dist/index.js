...
var PALETTE = [
  ...
  // index 17 – gold
  "#ADFF2F",
  // index 18 – green yellow
  "#FF69B4",
  // index 19 – hot pink
  "#8A2BE2",
  // index 20 – blue violet
  "#D2691E",
  // index 21 – chocolate
  "#6495ED",
  // index 22 – cornflower blue
  "#DC143C",
  // index 23 – crimson
  "#B22222",
  // index 24 – firebrick
  ...
  // index 29 – chartreuse
  "#FF8C00",
  // index 30 – dark orange
  "#9932CC",
  // index 31 – dark orchid
  "#FF1493",
  // index 32 – deep pink
  "#00BFFF",
  // index 33 – deep sky blue
  "#1E90FF",
  // index 34 – dodger blue
  "#32CD32",
  // index 35 – lime green
  "#FF6347",
  // index 36 – tomato
  ...
  // index 42 – light blue
  "#90EE90",
  // index 43 – light green
  "#D3D3D3",
  // index 44 – light gray
  "#FFFAF0",
  // index 45 – floral white
  "#F0E68C",
  // index 46 – khaki
  "#E6E6FA",
  // index 47 – lavender
  "#FFF0F5",
  // index 48 – lavender blush
  "#FAFAD2",
  // index 49 – light goldenrod yellow
  "#FFE4E1",
  // index 50 – misty rose
  "#F5F5DC",
  // index 51 – beige
  ...
  // index 55 – mint cream
  "#FFFFE0",
  // index 56 – light yellow
  "#FAF0E6",
  // index 57 – linen
  "#FFEBCD",
  // index 58 – blanched almond
  "#FFE4B5",
  // index 59 – moccasin
  "#FFDEAD",
  // index 60 – navajo white
  "#FFF8DC",
  // index 61 – cornsilk
  "#FDF5E6",
  // index 62 – old lace
  ...
  // index 63 – ivory
  "#F8F8FF"
  // index 64 – ghost white
];
var INDEX = Object.fromEntries(PALETTE.map((c, i) => [c, i]));
var app = new Hono2();
app.get("/palette", (c) => {
  return c.json({ palette: PALETTE });
});
["/grid", "/pixel", "/ws"].forEach(
  (p) => app.all(p, (c) => {
    const stub = c.env.GRID_STATE.get(c.env.GRID_STATE.idFromName("global"));
    return stub.fetch(c.req.raw);
  })
);
app.get("/callback", module({ path: "./public/callback.html" }));
app.get("*", module({ root: "./public" }));
var index_default = {
  fetch: app.fetch,
  GridDurableObject
};
var GridDurableObject = class {
  ...
  async fetch(request) {
    ...
    if (url.pathname === "/pixel" && request.method === "POST") {
      try {
        ...
        if (x == null || y == null || !color || x < 0 || x >= 500 || y < 0 || y >= 500) {
          return new Response(
  ...
  async loadGrid() {
    this.grid = Array(500).fill(0).map(() => Array(500).fill("#FFFFFF"));
    const pixels = await this.state.storage.list({ prefix: "pixel:" });
    for (const [key, color] of pixels) {
      const [, x, y] = key.split(":");
      if (this.grid[y] && this.grid[y][x] !== void 0) {
        this.grid[y][x] = color;
      }
    }
  }
...
__name(validateDiscordToken, "validateDiscordToken");
